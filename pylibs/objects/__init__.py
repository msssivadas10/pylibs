...
The objects module provides specialized objects to store data related 
to spectrum analysis. This include special tables to store the spectroscopic 
...
This module contains the :class:`Table` base class. Other special tables can 
be created as subclasses to this. For creating simple tables, use `table` 
